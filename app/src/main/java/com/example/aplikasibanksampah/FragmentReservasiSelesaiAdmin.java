...
public class FragmentReservasiSelesaiAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_reservasi_selesai_admin, container, false);
    }
    ...
    private void EventChangeListener() {
        ...
        fStore.collection("ReservasiPickUp").whereEqualTo("status", "Selesai").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
