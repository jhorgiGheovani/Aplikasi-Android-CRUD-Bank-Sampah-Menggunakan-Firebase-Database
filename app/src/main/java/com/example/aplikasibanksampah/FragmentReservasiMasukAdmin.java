...
public class FragmentReservasiMasukAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_reservasi_masuk_admin, container, false);
    }
    ...
    private void EventChangeListener() {
        ...
        fStore.collection("ReservasiPickUp").whereEqualTo("status", "Belum Diproses").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
